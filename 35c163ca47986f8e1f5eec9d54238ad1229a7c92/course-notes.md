...
[Fundamentals]({{ site.url }}{{ site.baseurl }}/content/fundamentals.pdf), 
[Front-end]({{ site.url }}{{ site.baseurl }}/content/front-end.pdf)
 and [Back-end]({{ site.url }}{{ site.baseurl }}/content/back-end.pdf)
